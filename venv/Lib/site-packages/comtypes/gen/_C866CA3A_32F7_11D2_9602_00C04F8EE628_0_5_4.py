...
__all__ = [
    ...
    'SREStateChange', 'SpeechTokenKeyUI', 'SPEI_SOUND_END',
    'DISPID_SVDisplayUI', 'eLEXTYPE_RESERVED6',
    'DISPID_SPRuleChildren', 'SPFILEMODE', 'STCRemoteServer',
    'SPGRAMMARWORDTYPE', 'DISPID_SGRSRule', 'eLEXTYPE_PRIVATE18',
    'SpeechVoiceEvents', 'SLOStatic',
    'SSSPTRelativeToCurrentPosition', 'ISpeechPhraseReplacement',
    'SREAudioLevel', 'SDTAudio', 'DISPID_SVAlertBoundary',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SpeechPhraseProperties',
    'DISPID_SpeechRecoContextEvents', 'SpeechGrammarTagWildcard',
    'DISPID_SPCLangId', 'SRSActiveAlways', 'SAFTADPCM_44kHzStereo',
    'DISPID_SRCESoundStart', 'SP_VISEME_20', 'SWTAdded',
    'DISPID_SPEsCount', 'SPSHT_NotOverriden', 'DISPID_SRCRecognizer',
    'SGSEnabled', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRSSupportedLanguages', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SDKEnumKeys', 'SGSDisabled', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SWFEFormatTag', 'SP_VISEME_10',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SOTs_NewEnum',
    'SpCompressedLexicon', 'SPXMLRESULTOPTIONS', 'SpStream',
    'tagSTATSTG', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'eLEXTYPE_PRIVATE3', 'SPWAVEFORMATTYPE', 'ISpDataKey',
    'SITooSlow', 'SAFTADPCM_44kHzMono', 'SPBO_PAUSE', 'SPWF_INPUT',
    'SpeechEmulationCompareFlags', 'DISPID_SRAudioInputStream',
    'SPLOADOPTIONS', 'SVEBookmark', 'DISPID_SVGetVoices',
    'SPPS_RESERVED1', 'SpeechDataKeyLocation', 'ISpeechAudio',
    'SPCS_ENABLED', 'SRAORetainAudio', 'SPSModifier', 'SPBO_AHEAD',
    'SVP_19', 'DISPID_SPPsCount', 'SPAUDIOSTATE',
    'SAFT11kHz16BitStereo', 'DISPIDSPRG', 'SPSLMA', 'SRERequestUI',
    'ISpeechLexiconPronunciations', 'SECFNoSpecialChars',
    'SpeechPropertyHighConfidenceThreshold', 'SLODynamic',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SOTCId',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SP_VISEME_21',
    'SAFTGSM610_44kHzMono', 'SAFT12kHz16BitStereo',
    '_ISpeechVoiceEvents', 'SPWORDLIST',
    'SpeechSpecialTransitionType', 'SVP_3', 'ISpeechGrammarRuleState',
    'STSF_CommonAppData', 'SAFT16kHz16BitStereo',
    'SAFT11kHz16BitMono', 'SVSFParseSapi', 'SPDKL_CurrentUser',
    'SpeechAddRemoveWord', 'SpeechPropertyResourceUsage',
    'DISPID_SGRsFindRule', 'DISPID_SGRAddResource', 'DISPID_SOTSetId',
    'DISPID_SPIAudioSizeTime', 'IInternetSecurityMgrSite',
    'SECFDefault', 'SPBO_TIME_UNITS',
    'DISPID_SVSyncronousSpeakTimeout', 'SpeechRecoEvents', 'SVP_6',
    'SPEVENTSOURCEINFO', 'DISPID_SpeechPhoneConverter',
    'SPINTERFERENCE_TOOSLOW', 'ISpeechRecoResult2', 'SGSExclusive',
    'eLEXTYPE_USER', 'DISPID_SPIGetDisplayAttributes',
    'SpeechCategoryRecognizers', 'DISPID_SRGRules', 'SPAR_High',
    'SAFT44kHz16BitStereo', 'SSFMOpenForRead', 'IStream',
    'DISPID_SpeechPhraseElements', 'SPWORD',
    'DISPID_SPRuleNumberOfElements', 'SAFT22kHz8BitStereo',
    'SPDKL_LocalMachine', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SRRAudioFormat', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SVStatus', 'ISpMMSysAudio', 'SPEI_REQUEST_UI',
    'SPSInterjection', 'SPPS_Interjection', 'SPEI_VISEME',
    'SPPS_Noun', 'DISPID_SRState', 'DISPID_SRCreateRecoContext',
    'SpeechTokenShellFolder', 'SVP_17', 'ISpShortcut', 'SPEI_PHONEME',
    'SDTDisplayText', 'SAFT11kHz8BitMono', 'SpeechEngineProperties',
    'SPEI_START_SR_STREAM', 'DISPID_SpeechMMSysAudio', 'SPEI_MAX_SR',
    'DISPID_SRIsShared', 'ISpeechPhraseAlternates',
    'SPEI_PHRASE_START', 'SPCATEGORYTYPE', 'SINoSignal',
    'SREPropertyNumChange', 'SVP_11', 'ISpeechPhraseElements',
    'SPSHORTCUTTYPE', 'SAFT32kHz8BitStereo', 'SVP_16',
    'SPEI_RESERVED3', 'ISpRecoCategory', 'DISPID_SRGRecoContext',
    'DISPID_SASNonBlockingIO', 'UINT_PTR',
    'ISpPhoneticAlphabetSelection', 'Speech_Max_Pron_Length',
    'STCAll', 'DISPID_SVPause', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SpeechAudioStatus', 'ISpeechRecoContext',
    'DISPID_SVGetAudioInputs', 'SPWF_SRENGINE', 'DISPID_SRCResume',
    'DISPID_SBSWrite', 'SPLO_DYNAMIC', 'DISPID_SBSRead',
    'DISPID_SPIGetText', 'SPPS_Function', 'DISPID_SPILanguageId',
    'SAFTCCITT_uLaw_44kHzStereo', 'SWPKnownWordPronounceable',
    'SpeechPropertyResponseSpeed', 'DISPID_SRGIsPronounceable',
    'DISPID_SGRsCommit', 'ISpeechLexicon', 'SP_VISEME_16',
    'SREPropertyStringChange', 'SAFT44kHz8BitMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SRCEPropertyStringChange',
    'SP_VISEME_19', 'DISPID_SPRules_NewEnum', 'SPPHRASERULE',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SOTGetDescription',
    'DISPID_SPRs_NewEnum', 'eWORDTYPE_ADDED', 'DISPID_SGRAddState',
    ...
    'SAFTGSM610_8kHzMono', 'DISPID_SVSCurrentStreamNumber',
    'SPRST_ACTIVE_ALWAYS', 'eLEXTYPE_PRIVATE20', 'DISPID_SGRSTText',
    'ISpRecognizer', 'SAFTADPCM_22kHzStereo', 'DISPID_SPPName',
    'SPEVENT', 'SAFTCCITT_uLaw_8kHzMono', 'SREPrivate',
    'DISPID_SGRsCount', 'SREHypothesis',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SVSpeakStream',
    'SPFM_NUM_MODES', 'DISPID_SPPEngineConfidence',
    'DISPID_SRCESoundEnd', 'DISPID_SRCEAdaptation',
    'DISPID_SOTCEnumerateTokens', 'SAFT48kHz8BitMono',
    'DISPID_SMSGetData', 'SAFT32kHz16BitMono', 'ISpStreamFormat',
    'ISpeechRecognizer', 'SVP_1', 'DISPID_SGRId', 'eLEXTYPE_PRIVATE9',
    'SREStreamStart', 'SpeechPropertyNormalConfidenceThreshold',
    'SRSInactive', 'SpeechTokenValueCLSID', 'SRESoundEnd',
    'DISPID_SGRsCommitAndSave', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SLWType', 'SPTEXTSELECTIONINFO', 'DISPID_SAStatus',
    'SpeechUserTraining', 'SASPause', 'SAFTADPCM_11kHzMono',
    'DISPID_SRGSetTextSelection',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SASCurrentDevicePosition',
    'DISPID_SPANumberOfElementsInResult', 'SP_VISEME_0',
    'DISPID_SRCERequestUI', 'DISPID_SPELexicalForm',
    'DISPID_SLPs_NewEnum', 'eLEXTYPE_PRIVATE16', 'ISpeechPhraseInfo',
    ...
    'DISPID_SRCRetainedAudioFormat', 'SPPROPERTYINFO',
    'DISPID_SRRRecoContext', 'SpeechEngineConfidence',
    'SRERecognition', 'SpSharedRecognizer',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPWT_DISPLAY', 'SVPOver',
    'SRSActive', 'DISPID_SVAudioOutput', 'DISPID_SPRNumberOfElements',
    'SPGS_EXCLUSIVE', 'DISPID_SGRSAddSpecialTransition',
    'SPVOICESTATUS', 'ISpeechGrammarRuleStateTransition', 'SPBO_NONE',
    'SAFT12kHz8BitStereo', 'DISPID_SPAs_NewEnum', 'SPAR_Low',
    'DISPID_SRCCmdMaxAlternates', 'SpeechCategoryRecoProfiles',
    'DISPID_SDKGetStringValue', 'SpeechAudioFormatGUIDText',
    'DISPID_SGRSTPropertyId', 'SAFT12kHz8BitMono',
    'DISPID_SVSLastBookmark', 'SPEI_RECOGNITION', 'DISPID_SRGId',
    'SpeechRecoProfileProperties', 'DISPID_SRGCommit',
    'ISpeechCustomStream', 'DISPID_SRRTOffsetFromStart',
    'ISpeechAudioFormat', 'WAVEFORMATEX', 'SPEI_PROPERTY_NUM_CHANGE',
    ...
    'DISPID_SPEs_NewEnum', 'DISPID_SDKDeleteKey', 'SDKLCurrentUser',
    'ISpeechPhraseReplacements', 'ISpeechAudioStatus',
    'DISPID_SPAPhraseInfo', 'SVEAudioLevel',
    'DISPID_SOTGetStorageFileName', 'SPPHRASE', 'DISPID_SLGetWords',
    'SVEStartInputStream', 'DISPID_SpeechBaseStream',
    'SpSharedRecoContext', 'DISPID_SRRTTickCount',
    'DISPID_SPRuleName', 'eLEXTYPE_PRIVATE13', 'SpeechAllElements',
    'SRTEmulated', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SRGDictationLoad', 'DISPID_SDKCreateKey',
    'DISPID_SPEEngineConfidence', 'IEnumSpObjectTokens',
    'ISpRecoContext2', 'SPSHT_EMAIL', 'DISPID_SGRSTWeight',
    'DISPID_SPERetainedStreamOffset', 'ISpeechWaveFormatEx',
    'SLTUser', 'DISPID_SGRsItem', 'Speech_StreamPos_Asap',
    'DISPID_SVEWord', 'SPRST_INACTIVE', 'SPFM_CREATE',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SWFEChannels',
    'SAFT16kHz8BitMono', 'DISPID_SAFType', 'DISPID_SDKSetBinaryValue',
    'ISpeechBaseStream', 'SAFTNonStandardFormat',
    'SpeechRuleAttributes', 'DISPID_SDKEnumValues', 'SPSFunction',
    'DISPID_SRCEAudioLevel', 'DISPID_SRCEPhraseStart',
    'DISPID_SpeechPhraseProperty', 'SpeechGrammarTagDictation',
    'DISPID_SBSSeek', 'SGRSTTWildcard', 'SAFT24kHz16BitStereo',
    'SPRULE', 'SPSUnknown', 'SPEI_RESERVED2',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SGRSTsItem',
    'SPEI_SR_AUDIO_LEVEL', 'SRTStandard', 'SPRECOSTATE',
    'DISPID_SVSPhonemeId', 'DISPID_SpeechVoiceStatus',
    'SpeechTokenKeyFiles', 'SRSEDone', 'SVSFIsNotXML',
    'DISPID_SOTCSetId', 'DISPID_SpeechLexiconProns',
    'SpeechStreamFileMode', 'DISPID_SPPConfidence', 'SVPAlert',
    'SAFT48kHz16BitStereo', 'ISpStreamFormatConverter',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SLWPronunciations',
    'SPAR_Medium', 'DISPID_SMSADeviceId',
    'ISpeechObjectTokenCategory', 'SpeechLoadOption', 'SASStop',
    'DISPID_SGRsAdd', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SGRAttributes', 'SRADynamic',
    'DISPIDSPTSI_SelectionOffset', 'SPEI_SOUND_START', 'SPSNoun',
    'SFTSREngine', 'SPRS_ACTIVE', 'SpVoice',
    'DISPID_SPRDisplayAttributes', 'SVEPrivate', 'ISpeechPhraseRule',
    'DISPID_SWFEExtraData', 'DISPID_SVWaitUntilDone',
    'SREFalseRecognition', 'SRARoot', 'DISPID_SRGDictationUnload',
    'DISPID_SGRs_NewEnum', 'SPRST_ACTIVE', 'DISPID_SGRSTNextState',
    'SPCONTEXTSTATE', 'DISPID_SASFreeBufferSpace',
    'SPSERIALIZEDRESULT', 'DISPID_SRRPhraseInfo',
    'DISPID_SGRInitialState', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SpeechMemoryStream', 'SPEI_RESERVED1', 'SP_VISEME_17',
    'DISPID_SOTId', 'eLEXTYPE_PRIVATE15',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPAS_CLOSED',
    'SpStreamFormatConverter', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SRRecognizer', 'DISPID_SPAsItem', 'SPCT_SUB_COMMAND',
    'DISPID_SpeechLexiconPronunciation', 'SGRSTTTextBuffer',
    ...
    'SpeechAudioProperties', 'SpeechAudioState', 'SPPS_Noncontent',
    'SpShortcut', 'ISpeechRecoResultTimes', 'ISpRecoResult',
    'SAFT32kHz8BitMono', 'SGDisplay', 'STCInprocServer',
    'DISPID_SpeechLexicon', 'SVF_Stressed', 'STSF_LocalAppData',
    'ISpeechLexiconPronunciation', 'SVP_14', 'SPEI_END_SR_STREAM',
    'DISPID_SRCPause', 'DISPID_SRCBookmark', 'SVP_18',
    ...
    'SAFTCCITT_ALaw_22kHzStereo', 'SpNotifyTranslator', 'SDTProperty',
    'DISPID_SVResume', 'SPEI_MIN_SR', 'SVF_None', 'SGLexical',
    'DISPID_SpeechFileStream', 'DISPID_SPEAudioStreamOffset',
    'SVP_13', 'DISPID_SVEPhoneme', 'SPRECOCONTEXTSTATUS',
    'SPBOOKMARKOPTIONS', 'DISPID_SRCRetainedAudio', 'SPCT_DICTATION',
    'DISPID_SRRSpeakAudio', 'eLEXTYPE_USER_SHORTCUT',
    'SAFT8kHz16BitMono', 'SITooFast', 'SAFT11kHz8BitStereo',
    'SpeechPropertyComplexResponseSpeed', 'SPPS_Verb',
    'SVEEndInputStream', 'STCInprocHandler', 'DISPID_SGRSTType',
    'DISPID_SRGDictationSetState', 'SDTReplacement', 'SPPS_LMA',
    'SVEVoiceChange', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SLAddPronunciation', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRRAlternates', 'SAFTCCITT_ALaw_11kHzMono',
    'ISpeechXMLRecoResult', 'DISPID_SRGetRecognizers',
    'SpeechStreamSeekPositionType', 'SRSEIsSpeaking',
    'SVESentenceBoundary', 'Speech_Default_Weight',
    'ISpeechPhraseRules', 'SpMMAudioOut', 'SAFTADPCM_8kHzMono',
    'SITooQuiet', 'DISPID_SRGSetWordSequenceData',
    'SpeechAudioVolume', 'SPRST_NUM_STATES', 'SVSFIsFilename',
    'SpeechLexiconType', 'DISPID_SRCAudioInInterferenceStatus',
    'SPPHRASEELEMENT', 'ISpeechLexiconWords',
    'SAFTCCITT_ALaw_11kHzStereo', 'SGLexicalNoSpecialChars',
    'ISpeechMMSysAudio', 'DISPID_SWFEBitsPerSample',
    'SpeechRecoContextState', 'DISPID_SRCEStartStream',
    'DISPID_SLWLangId', 'DISPID_SVEAudioLevel', 'DISPID_SRGState',
    'DISPID_SWFESamplesPerSec', 'SRTSMLTimeout', 'SPGS_ENABLED',
    'SP_VISEME_8', 'DISPID_SRCVoice', 'DISPID_SFSOpen',
    'SPRST_INACTIVE_WITH_PURGE', 'SVP_15', 'ISpEventSink',
    'SSTTTextBuffer', 'SpeechFormatType', 'SPEI_RECO_STATE_CHANGE',
    'SPEI_SR_RETAINEDAUDIO', 'SPFM_OPEN_READWRITE',
    'SAFTGSM610_22kHzMono', 'SpeechRunState', 'ISpRecoGrammar2',
    'DISPID_SOTsItem', 'SECNormalConfidence', 'SVP_8',
    'SPAUDIOBUFFERINFO', 'DISPID_SPIProperties', 'SPCT_SLEEP',
    'SPEI_MIN_TTS', 'DISPID_SWFEBlockAlign', 'SAFT16kHz8BitStereo',
    'SAFTADPCM_8kHzStereo', 'DISPID_SPEActualConfidence',
    'ISpeechPhoneConverter', 'Speech_StreamPos_RealTime',
    'SDKLLocalMachine', 'SAFT48kHz8BitStereo', 'SRSInactiveWithPurge',
    'SPAO_RETAIN_AUDIO', 'DISPID_SOTMatchesAttributes',
    'DISPID_SpeechRecoResultTimes', 'SPAS_STOP', 'SVSFNLPMask',
    'DISPID_SPPsItem', 'SPEI_INTERFERENCE', 'SPSMF_UPS',
    'eLEXTYPE_APP', 'SPBINARYGRAMMAR', 'SpeechMicTraining',
    'SpeechRecognizerState', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRCERecognition', 'DISPID_SLGetGenerationChange',
    'SpeechCategoryAudioIn', 'ISequentialStream', 'DISPID_SPRsItem',
    'Speech_Max_Word_Length', 'SPEI_ADAPTATION', 'SPPS_RESERVED3',
    'SRATopLevel', 'SAFT16kHz16BitMono', 'SAFT44kHz8BitStereo',
    'eLEXTYPE_PRIVATE19', 'SpeechGrammarWordType', 'DISPID_SPIRule',
    'DISPID_SLPsItem', 'ISpeechResourceLoader', 'DISPID_SLWsCount',
    'SPFM_OPEN_READONLY', 'eWORDTYPE_DELETED', 'DISPID_SLWs_NewEnum',
    'DISPID_SpeechRecoContext', 'SpeechCategoryAppLexicons',
    'DISPID_SRCEventInterests', 'DISPID_SPEAudioTimeOffset',
    'tagSPPROPERTYINFO', 'DISPID_SPPs_NewEnum',
    'eLEXTYPE_VENDORLEXICON', 'SPSMF_SAPI_PROPERTIES', 'SVP_0',
    'SWPUnknownWordUnpronounceable', 'SPSNotOverriden',
    'ISpeechPhraseAlternate', 'DISPID_SPPValue', 'SPEI_TTS_PRIVATE',
    'SPPS_RESERVED4', 'DISPID_SPIAudioSizeBytes', 'DISPID_SVRate',
    'SPPS_Unknown', 'DISPID_SVIsUISupported', 'SP_VISEME_13',
    'ISpProperties', 'DISPID_SPACommit', 'STSF_FlagCreate',
    'DISPID_SVSLastStreamNumberQueued', '_RemotableHandle',
    'SGRSTTDictation', '__MIDL_IWinTypes_0009', 'DISPID_SASState',
    'DISPID_SRCCreateGrammar', 'SpeechRegistryUserRoot',
    'SP_VISEME_7', 'SAFTNoAssignedFormat', 'ISpeechGrammarRule',
    'DISPID_SPEsItem', 'DISPID_SVEEnginePrivate', 'DISPID_SVEViseme',
    'SBONone', 'SpFileStream', 'SVSFParseMask',
    '_ISpeechRecoContextEvents', 'DISPID_SpeechVoiceEvent',
    'eLEXTYPE_PRIVATE5', 'SDKLDefaultLocation',
    'DISPID_SRIsUISupported', 'SPSSuppressWord',
    'DISPID_SPEPronunciation', 'SpeechPropertyAdaptationOn',
    'SPEI_HYPOTHESIS', 'DISPID_SPEDisplayText', 'SGRSTTWord',
    ...
    'SAFT44kHz16BitMono', 'SVEViseme', 'SAFT48kHz16BitMono', 'SVP_9',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SOTDisplayUI',
    'SPPS_Modifier', 'SPEI_SR_PRIVATE', 'DISPID_SRGCmdLoadFromObject',
    'ISpeechDataKey', 'DISPID_SRRTimes', 'LONG_PTR',
    'SAFT8kHz8BitMono', 'SP_VISEME_3', 'SVSFPurgeBeforeSpeak',
    'SPEI_MAX_TTS', 'SRAONone', 'ISpGrammarBuilder',
    'SpPhraseInfoBuilder', 'DISPID_SRCEFalseRecognition',
    'eLEXTYPE_LETTERTOSOUND', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'eLEXTYPE_PRIVATE1', 'SpObjectTokenCategory', 'SP_VISEME_6',
    'DISPID_SRCEHypothesis', 'eLEXTYPE_PRIVATE7',
    'SpeechGrammarRuleStateTransitionType', 'SPSVerb',
    'DISPID_SPPFirstElement', 'DISPID_SPIGrammarId', 'ISpRecoGrammar',
    'DISPID_SRGCmdLoadFromResource', 'SVSFUnusedFlags',
    'SPEI_UNDEFINED', 'DISPID_SDKGetBinaryValue',
    'ISpeechObjectTokens', 'SINoise', 'SPADAPTATIONRELEVANCE',
    'DISPID_SVGetAudioOutputs', 'SAFT24kHz16BitMono',
    'SDA_Two_Trailing_Spaces', 'SPRECOGNIZERSTATUS',
    'DISPID_SLPPartOfSpeech',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPEI_END_INPUT_STREAM', 'DISPID_SVEBookmark',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SRCVoicePurgeEvent',
    'SGDSActiveWithAutoPause', 'SVPNormal', 'SPVPRI_OVER',
    'SPWT_PRONUNCIATION', 'DISPID_SRRDiscardResultInfo',
    'SVEAllEvents', 'SSTTWildcard', 'DISPID_SPRsCount', 'SVP_21',
    'SFTInput', 'SPEI_FALSE_RECOGNITION', 'SPEI_RECO_OTHER_CONTEXT',
    'eLEXTYPE_RESERVED9', 'DISPID_SMSAMMHandle', 'SDTAlternates',
    'SPAS_RUN', 'SpeechVoicePriority', 'SpCustomStream',
    'SVSFPersistXML', 'DISPID_SRSNumberOfActiveRules',
    'ISpeechGrammarRules', 'SP_VISEME_4',
    'SDA_Consume_Leading_Spaces', 'SpMemoryStream',
    'eLEXTYPE_PRIVATE4', 'DISPID_SDKGetlongValue', 'SWTDeleted',
    'SPRS_INACTIVE', 'SP_VISEME_18', 'SRADefaultToActive',
    ...
    'ISpResourceManager', 'DISPID_SPISaveToMemory',
    ...
    'DISPID_SOTRemove', 'eLEXTYPE_RESERVED8', 'SPDKL_CurrentConfig',
    'DISPID_SGRSTransitions', 'ISpeechRecoResultDispatch',
    'DISPID_SRCSetAdaptationData', 'ISpNotifyTranslator',
    'IEnumString', 'DISPID_SRSClsidEngine',
    'DISPID_SDKSetStringValue', 'DISPID_SLPLangId',
    'DISPID_SPAsCount', 'DISPID_SRProfile',
    'DISPID_SRSetPropertyString', 'DISPID_SLRemovePronunciation',
    'SPPS_RESERVED2', 'SPLO_STATIC', 'SAFTText',
    'SAFTADPCM_11kHzStereo', 'DISPID_SLWWord',
    'DISPID_SPIReplacements', 'DISPID_SRRTStreamTime',
    'SPEI_SENTENCE_BOUNDARY', 'SpeechWordType', 'ISpAudio',
    'SAFT24kHz8BitMono', 'SBOPause', 'SSSPTRelativeToStart',
    'SpeechDiscardType', 'DISPID_SAFGuid', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SRStatus', 'ISpXMLRecoResult', 'SpeechDisplayAttributes',
    'ISpRecognizer2', 'SPAO_NONE', 'DISPID_SOTCDefault',
    'DISPID_SVVoice', 'ISpeechPhraseProperties',
    'DISPID_SRCEInterference', 'ISpRecoContext',
    'DISPID_SPCPhoneToId', 'DISPID_SVEventInterests',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPSHORTCUTPAIRLIST',
    'DISPID_SpeechPhraseRule', 'SVP_20', 'SpLexicon',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRCEEnginePrivate',
    'SpeechRuleState', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPIDSPTSI_ActiveLength', 'SPXRO_Alternates_SML', 'SpMMAudioIn',
    'DISPID_SRCState', 'SGRSTTEpsilon', 'DISPID_SpeechDataKey',
    'SP_VISEME_1', 'DISPID_SpeechPhraseReplacements',
    'SRAInterpreter', 'DISPID_SGRSTPropertyName',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SAFT22kHz8BitMono',
    'SPRS_ACTIVE_USER_DELIMITED', 'SVP_12', 'SDKLCurrentConfig',
    'SpTextSelectionInformation', 'DISPID_SLPsCount',
    'ISpeechLexiconWord', 'SpInprocRecognizer', 'eLEXTYPE_PRIVATE2',
    'SVP_5', 'ISpObjectToken', 'DISPID_SRGetPropertyNumber',
    'SpeechDictationTopicSpelling', 'DISPID_SGRSTsCount',
    'SP_VISEME_2', 'DISPID_SRGReset', 'DISPID_SPEAudioSizeTime',
    'SPCT_COMMAND', 'ISpeechObjectToken',
    'DISPID_SREmulateRecognition', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SVSpeakCompleteEvent', 'SpeechWordPronounceable',
    'SGDSActive', 'SVP_4', 'SGRSTTRule', 'SpeechVoiceSpeakFlags',
    'DISPID_SPIElements', 'DISPID_SPRulesCount',
    'DISPID_SABufferInfo', 'DISPID_SpeechPhraseRules',
    'SpeechVisemeType', 'eLEXTYPE_PRIVATE10', 'STCLocalServer',
    'ISpeechPhraseInfoBuilder', 'SPDKL_DefaultLocation',
    'SPINTERFERENCE', 'DISPID_SpeechAudioBufferInfo', 'SPSHT_OTHER',
    'SAFTCCITT_ALaw_22kHzMono', 'SECFEmulateResult',
    'DISPID_SMSALineId', 'DISPID_SOTCreateInstance',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SpeechRecoResult2',
    'SPRECORESULTTIMES', 'ISpeechVoiceStatus', 'SpeechVisemeFeature',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SASetState',
    'SPCT_SUB_DICTATION', 'DISPID_SVSVisemeId', 'SVP_7',
    'eLEXTYPE_PRIVATE8', 'SREPhraseStart',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SADefaultFormat',
    'SPEI_VOICE_CHANGE', 'SAFT22kHz16BitStereo', 'SRAImport',
    'SPINTERFERENCE_LATENCY_WARNING', 'eLEXTYPE_PRIVATE17',
    'SREInterference', 'ISpPhoneticAlphabetConverter',
    'DISPID_SVPriority', 'SREAllEvents', 'ISpeechVoice',
    'SAFT8kHz8BitStereo', 'SPCS_DISABLED', 'SpObjectToken',
    'SpeechCategoryVoices', 'DISPID_SGRClear', 'SRCS_Enabled',
    'DISPID_SPARecoResult', 'SpWaveFormatEx', 'SPSHT_Unknown',
    'DISPID_SLPPhoneIds', 'SpeechTokenKeyAttributes',
    'DISPID_SpeechGrammarRule', 'DISPID_SOTDataKey',
    'SPPHRASEPROPERTY', 'SECLowConfidence', 'SAFT12kHz16BitMono',
    'SRCS_Disabled', '_SPAUDIOSTATE', 'SP_VISEME_11',
    'ISpEventSource', 'DISPID_SPRText', 'SAFT24kHz8BitStereo',
    'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SRGetFormat',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPIRetainedSizeBytes',
    'eLEXTYPE_PRIVATE6', 'SPAR_Unknown', 'SPSHORTCUTPAIR',
    'SVSFParseAutodetect', 'SpPhoneticAlphabetConverter',
    'SPLEXICONTYPE', 'SPPHRASEREPLACEMENT', 'ISpeechPhraseProperty',
    'DISPID_SGRName', 'SVP_10', 'DISPID_SRSCurrentStreamPosition',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SOTsCount', 'SASClosed',
    'SVSFVoiceMask', 'DISPID_SpeechAudio', 'ISpSerializeState',
    'SpAudioFormat', 'DISPID_SABIMinNotification',
    'eLEXTYPE_MORPHOLOGY', 'SSFMCreate', 'DISPID_SVSLastBookmarkId',
    'SpNullPhoneConverter', 'DISPID_SpeechAudioFormat',
    'DISPID_SGRSTRule', 'SAFTGSM610_11kHzMono',
    'DISPID_SVSLastResult', 'eLEXTYPE_RESERVED4', 'SECFIgnoreCase',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpRecognizer3', 'SPVPRI_NORMAL',
    'DISPID_SVGetProfiles', 'SVSFDefault', 'DISPID_SRAudioInput',
    'SSSPTRelativeToEnd', 'DISPID_SVVolume',
    'SGDSActiveUserDelimited', 'SpUnCompressedLexicon',
    'SPGRAMMARSTATE', 'ISpeechPhraseElement', 'SASRun',
    'DISPID_SPPChildren', 'DISPID_SPRuleParent', 'SPSERIALIZEDPHRASE',
    'DISPID_SWFEAvgBytesPerSec', 'SPSMF_SRGS_SAPIPROPERTIES',
    'ISpObjectTokenCategory', 'DISPID_SVSInputWordPosition',
    'SPEVENTENUM', 'ISpPhraseAlt', 'SPDATAKEYLOCATION',
    'DISPID_SVSkip', 'SPAS_PAUSE', 'SPSEMANTICFORMAT',
    'ISpeechFileStream', 'SPEI_WORD_BOUNDARY', 'SP_VISEME_15',
    'ISpeechAudioBufferInfo', 'DISPID_SGRsDynamic',
    'DISPID_SVEStreamEnd', 'SPWT_LEXICAL',
    'DISPID_SRGetPropertyString', 'SREBookmark',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SDKSetLongValue', 'DISPIDSPTSI', 'SVF_Emphasis', 'SVP_2',
    'SpeechTokenContext', 'SVEWordBoundary', 'SpeechGrammarState',
    'DISPID_SABufferNotifySize', 'SPEI_RESERVED5', 'SITooLoud',
    'SPEI_RESERVED6', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechTokenIdUserLexicon', 'DISPID_SpeechPhraseBuilder',
    'SAFTDefault', 'SVSFIsXML', 'SSTTDictation', 'SAFT22kHz16BitMono',
    'DISPID_SpeechObjectTokens', 'SPVPRIORITY', 'SECFIgnoreKanaType',
    'SpeechRetainedAudioOptions', 'ISpPhrase', 'SRAExport',
    'DISPID_SRRSaveToMemory', 'SPVISEMES', 'DISPID_SPIEngineId',
    'DISPID_SpeechPhraseInfo', 'SDTPronunciation', 'SPRULESTATE',
    'SpeechInterference', 'SP_VISEME_12',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SFSClose',
    'SPINTERFERENCE_NONE', 'DISPID_SPRuleConfidence',
    'SAFTADPCM_22kHzMono', 'DISPID_SpeechObjectToken',
    'DISPID_SLWsItem', 'SGDSInactive', 'SPEI_SR_BOOKMARK',
    'DISPID_SVEVoiceChange', 'DISPID_SRSAudioStatus',
    'SpPhoneConverter', 'DISPID_SPERequiredConfidence',
    'DISPID_SpeechPhraseElement', 'SRTExtendableParse',
    'DISPID_SMSSetData', 'SSFMCreateForWrite', 'SPPS_SuppressWord',
    'SDTRule', 'DISPID_SpeechCustomStream', 'SECHighConfidence',
    'DISPID_SVSInputWordLength', 'SRTAutopause', 'SPXRO_SML',
    'ISpNotifySource', 'DISPID_SVSRunningState', 'eLEXTYPE_RESERVED7',
    'SRESoundStart', 'SVSFParseSsml', 'DISPID_SpeechVoice',
    ...
    'SREStreamEnd', 'STSF_AppData', 'SpeechBookmarkOptions',
    'DISPID_SPRFirstElement', 'DISPID_SRGCmdLoadFromMemory',
    'ISpeechMemoryStream', 'DISPID_SASCurrentSeekPosition',
    'SPGS_DISABLED', 'DISPID_SOTCategory', 'eLEXTYPE_RESERVED10',
    'eLEXTYPE_PRIVATE14', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPFM_CREATE_ALWAYS', 'DISPID_SRRAudio',
    'DISPID_SpeechRecoResult', 'DISPID_SRCRequestedUIType',
    'SpMMAudioEnum', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SPPARTOFSPEECH', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SLGenerationId', 'ISpLexicon', 'eLEXTYPE_PRIVATE11',
    'DISPID_SDKOpenKey', 'DISPID_SRRGetXMLResult',
    'ISpeechRecoResult', 'DISPID_SGRSTPropertyValue',
    'DISPID_SABIEventBias', 'SLTApp', 'DISPIDSPTSI_SelectionLength',
    'ISpeechRecoGrammar', 'tagSPTEXTSELECTIONINFO', 'SVSFlagsAsync',
    'SECFIgnoreWidth', 'SPAUDIOOPTIONS',
    'DISPID_SPIEnginePrivateData', 'SPINTERFERENCE_NOISE',
    'IInternetSecurityManager', 'SRTReSent', 'SpeechRecognitionType',
    'SP_VISEME_14', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SVESentenceBoundary', 'SVEPhoneme',
    'SpeechAudioFormatGUIDWave', 'SpeechCategoryAudioOut',
    'DISPID_SpeechRecognizer', 'SSFMOpenReadWrite',
    'DISPID_SOTIsUISupported', 'ISpPhoneConverter',
    'ISpObjectWithToken', 'ISpVoice', 'DISPID_SVAudioOutputStream',
    'DISPID_SRCEBookmark', 'SpeechPartOfSpeech',
    'SAFTCCITT_uLaw_11kHzMono', 'SGPronounciation',
    'DISPID_SVEStreamStart', 'SVSFNLPSpeakPunc',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SPRuleFirstElement',
    'DISPID_SRCCreateResultFromMemory', 'SDTAll', 'SINone',
    'DISPID_SAEventHandle', 'SpInProcRecoContext',
    'SDA_One_Trailing_Space', 'SPAUDIOSTATUS',
    'ISpeechTextSelectionInformation', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SPCIdToPhone', 'ISpNotifySink', 'SPPS_NotOverriden',
    'DISPID_SRDisplayUI', 'DISPID_SOTCGetDataKey', 'DISPID_SPPParent',
